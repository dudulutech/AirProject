...
public class KassirThreadKabyldau extends Thread{
    Socket socket;
    ObjectInputStream ois;
    Connection connection;
    public KassirThreadKabyldau(Socket socket,Connection connection) throws IOException{
        this.socket = socket;
    ...
    public void run() {
        while (true) {
            try {
                ...
                if (object instanceof EditTicketsPackage){
                    EditTicketsPackage ep = (EditTicketsPackage)object;
